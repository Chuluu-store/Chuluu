          ...
          >
            <div className="w-full max-w-md bg-stone-800/90 backdrop-blur-xl border border-stone-700/50 rounded-3xl shadow-2xl p-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-white">{type === 'create' ? '그룹 생성' : '그룹 참가'}</h2>
                <button onClick={onClose} className="p-3 hover:bg-stone-700/30 rounded-xl transition-all duration-200">
              ...
              {!success ? (
                  ...
                  {type === 'create' ? (
                    <>
                      <div className="space-y-3">
                        <label className="block text-sm font-medium text-stone-300">그룹 이름</label>
                        <input
                          type="text"
                          value={formData.name}
                          ...
                          placeholder="예: 몽골 여행 2025"
                          required
                        />
                      </div>

                      <div className="space-y-3">
                        <label className="block text-sm font-medium text-stone-300">설명 (선택)</label>
                        <textarea
                    ...
                    <div className="space-y-4">
                      <div className="space-y-3">
                        <label className="block text-sm font-medium text-stone-300 text-center">초대 코드</label>
                        <input
                          type="text"
                      ...
                      <p className="text-xs text-stone-400 text-center">친구에게 받은 6자리 초대 코드를 입력하세요</p>
                    </div>
                  )}
                ...
                >
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-white">그룹이 생성되었습니다!</h3>
                    <p className="text-sm text-stone-400">초대 코드를 친구들과 공유하세요</p>
                  </div>

                  <div className="bg-stone-900/40 border border-stone-700/40 py-4 px-4 rounded-2xl space-y-3">
                    <p className="text-xs text-stone-400 font-medium">초대 코드</p>
